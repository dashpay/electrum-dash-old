...
cp -av ${BUILD_REPO}/icons/electrum-dash-logo.jpg Resources/en.lproj/background



#pkgbuild --analyze --root ${INSTALL_ROOT} 'Electrum-DASH.plist'
...
#echo "sed"
sed -e '$ i\
 \    <title>Electrum-DASH '${VERSION}'</title>' \
 -e '$ i\
