...
if [ "$(uname)" = "Darwin" ];
  ...
  #mv Electrum-DASH-${VER}.dmg helpers/release-packages/OSX
  ...
  mkdir Electrum-DASH.app/Contents/Resources/lib/python2.7/site-packages
  pushd  Electrum-DASH.app/Contents/Resources/lib/python2.7/site-packages
